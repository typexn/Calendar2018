...
class diary_ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        //이미지뷰 + 이미지뷰 버튼 누르면 카메라 촬영 페이지로 가게 -> 임시로 해보는 거임
        ImageView imageView = (ImageView) convertView.findViewById(R.id.diary_imageview_photo);
        imageView.setImageResource(R.drawable.ic_launcher_foreground);   //임시 이미지
